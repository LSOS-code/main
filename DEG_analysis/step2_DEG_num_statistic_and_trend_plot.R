##### description: Statistics on the number of DEGs (Fig. 1c and Extended Data Fig. 5b) and presentation of the changing trend (Fig. 3c and Extended Data Fig. 5c)
#DEG_list_trends.Rds, T1_to_T2_DEG_table.txt, T1_to_T2_DEG_table.txt, T1_to_T3_DEG_table.txt and DEG_list.Rds are available in "DEG_analysis/result"
...
workdir <- "DEG_analysis/result/180-day spaceflight_M180-2/"
...
write.csv(logFC_df, file = "Changing trend of DEGs M180-1.csv", row.names=F)
...
ggpubr::ggarrange(up_plot, down_plot, ncol = 1, nrow = 2)

#trend_matrix: col:time by order; rownames:gene; value:logFCs compared to the previous time point
