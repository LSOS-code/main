##### description: density of gene expression logFCs in T3_vs_T1
...
workdir <- "DEG_analysis/result/90-day spaceflight_M90/"
setwd(workdir)
...
##### 01End: 90 DEG logFC density #####



##### 02Start: 1logFC density of DEGs in M180-1 #####
workdir <- "DEG_analysis/result/180-day spaceflight_M180-1/"
setwd(workdir)
...
p_T3_vs_T1_02 <- ggplot(sig_DEG_T1_to_T3_02,aes(x=logFC,fill=change_type, alpha = 0.01))+geom_density()+ 
                 scale_x_continuous(limits = c(-2, 2))  +
                 scale_fill_manual(values=c(down_up = "#83AEDC", stable_up = "#5F559B", up_down = "#C14E8B", stable_down = "#985CB8", up_stable="#4FB895", down_stable="#C88AB9"))
##### 02End: 180 DEG logFC density #####

#Combination of diagrams
ggpubr::ggarrange(p_T3_vs_T1_01, p_T3_vs_T1_02, ncol=1, nrow=2)
